...
import ProfilePhotoPicker from "@/modules/WFM/employee/components/custom/ProfilePhotoPicker";
...
import { DepartmentSelector } from "../custom/departmentSelector";
import { RegisterModel } from "@/modules/IAM/auth/model/RegisterModel";
import { RegisterPersonel } from "@/modules/IAM/auth/service/authService";
  ...
  const handleSave = async () => {
    run(async () => {
      ...
      if ((response.status = 201)) {
        ...
        const data = await RegisterPersonel(
          {
        ...
        if (profilePhoto === null) {
          clearErrors();
          showSuccess("Personel Oluşturuldu.");
          ...
          <div>
            ...
            <div className="mb-6 flex justify-center">
              <ProfilePhotoPicker
                ...
                defaultPhotoUrl={formData?.avatarUrl} // önceki resmi göstermek için
              />
            </div>
                  ...
                  onChange={value => {
                    setFormData(prev =>
                      prev
                        ...
                        : ({ departmentId: value } as PersonelAddModel),
                    );
                  }}
