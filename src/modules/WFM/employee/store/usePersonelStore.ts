...
import {
  ...
  PersonelSelectModel,
  PersonelUpdateModel,
} from "@/modules/WFM/employee/model/personel";
import {
  GetAllPersonel,
  GetByIdPersonel,
  GetListByDynamicPersonel,
  GetListPersonel,
} from "@/modules/WFM/employee/service/personelService";
...
interface PersonelState {
  ...
  setUpdateField: (field: keyof PersonelUpdateModel, value: string | number) => void;
