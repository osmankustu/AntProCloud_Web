...
import personelPermissions from "@/modules/WFM/constants/personelPermission.const";
import { DepartmentModel } from "../../model/department";
import { DeleteDepartment } from "../../service/departmentService";

const DepartmentMetaCard = ({
    department,
    setActive,
}: {
...
export default DepartmentMetaCard;
