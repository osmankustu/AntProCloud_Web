...
const UserAccountInformationCard = () => {
      ...
      <div className="rounded-2xl border border-gray-200 p-5 lg:p-6 dark:border-gray-800">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-5 lg:gap-7 2xl:gap-x-16">
              <div>
                <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Adı-Soyadı</p>
        ...
        <Modal mode="wait" isOpen={isOpen} onClose={closeModal} className="m-4 max-w-[900px]">
          <UserEditForm isOpen={isOpen} onClose={closeModal} />
        </Modal>
      </div>
    </div>
  );
