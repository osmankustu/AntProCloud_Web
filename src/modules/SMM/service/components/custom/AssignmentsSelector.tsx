...
import { PersonelSelectModel } from "@/modules/WFM/employee/model/personel";
import { TeamSelectModel } from "@/modules/WFM/team/model/team";
...
export const AssignmentSelector: React.FC<Props> = ({
  ...
  const getOptions = (): Option[] => {
    if (type === "personel") {
      ...
      return teamList.map(t => ({ value: t?.id, label: t?.fullName + "   |" + t?.code }) as Option);
    }
    return [];
  };
