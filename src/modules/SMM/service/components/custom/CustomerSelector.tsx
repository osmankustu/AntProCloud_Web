...
import { CorporateCustomerSelectModel } from "@/modules/CRM/customer/corporate/model/corporateCustomer";
import { IndividualCustomerSelectModel } from "@/modules/CRM/customer/individual/model/IndividualCustomer";

interface Props {
  corporateCustomers: CorporateCustomerSelectModel[];
  individualCustomers: IndividualCustomerSelectModel[];
  defaultType?: string;
