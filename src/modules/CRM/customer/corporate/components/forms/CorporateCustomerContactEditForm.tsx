    ...
    const fetchFormData = () => {
      if (corporateCustomer) {
        setUpdateFormData({
          ...
          authorizedPerson: corporateCustomer?.authorizedPerson,
          authorizedPersonEmail: corporateCustomer?.authorizedPersonEmail,
          authorizedPersonPhone: corporateCustomer?.authorizedPersonPhone,
          createdDate: corporateCustomer?.createdDate,
        });
      }
    };
    fetchFormData();
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  <div className="col-span-2 lg:col-span-1">
                    ...
                    <Input
                      ...
                      type="text"
                      value={updateFormData?.authorizedPerson}
                      name="authorizedPerson"
                      onChange={e => setUpdateField("authorizedPerson", e.target.value)}
                      error={!!errors.AuthorizedPerson}
                      hint={errors.AuthorizedPerson!}
                    />
                  </div>
                  ...
                  <div className="col-span-2 lg:col-span-1">
                    ...
                    <Input
                      ...
                      type="text"
                      value={updateFormData?.authorizedPersonPhone}
                      name="authorizedPhoneNumber"
                      onChange={e => setUpdateField("authorizedPersonPhone", e.target.value)}
                  ...
                  <div className="col-span-2 lg:col-span-1">
                    ...
                    <Input
                      id="authorizedEmail"
                      type="text"
                      value={updateFormData?.authorizedPersonEmail}
                      name="authorizedPersonEmail"
                      onChange={e => setUpdateField("authorizedPersonEmail", e.target.value)}
