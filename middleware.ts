...
const roleMap: Record<string, string[]> = {
  "/management/jobs": ["admin"],
  "/management/services": ["admin", "service.read", "service.*"], // management sayfası için gerekli roller
  "/management/customers/": ["admin", "customer.read", "customer.*"],
  "/management/employees/": ["admin", "employee.read", "employeee.*"],
